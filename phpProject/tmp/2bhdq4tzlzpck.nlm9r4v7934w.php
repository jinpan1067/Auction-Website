    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        ...
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            <li class="nav-item active">
                <a class="nav-link" href="http://localhost:81/teamProject/">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="http://localhost:81/teamProject/auction">Auction</a>
            </li>
        ...
        <form class="form-inline my-2 my-lg-0" action="login" method="post">
            ...
            <?php else: ?>
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost:81/teamProject/profile">Profile</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost:81/teamProject/items">Add items</a>
                    </li>
                </ul>
